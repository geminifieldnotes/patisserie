...
class CoffeeTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee_type" do
    assert_difference("CoffeeType.count") do
      post coffee_types_url, params: { coffee_type: { description: @coffee_type.description, name: @coffee_type.name } }
    end
  ...
  test "should update coffee_type" do
    patch coffee_type_url(@coffee_type), params: { coffee_type: { description: @coffee_type.description, name: @coffee_type.name } }
