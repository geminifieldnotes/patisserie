...
class CoffeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee" do
    assert_difference("Coffee.count") do
      post coffees_url, params: { coffee: { description: @coffee.description, name: @coffee.name, price: @coffee.price } }
    end
  ...
  test "should update coffee" do
    patch coffee_url(@coffee), params: { coffee: { description: @coffee.description, name: @coffee.name, price: @coffee.price } }
